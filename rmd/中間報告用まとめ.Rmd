...
# 表記を店名にするため
receipt$store_id_name <- factor(receipt$store_id, labels = store_names)
...
#最寄駅
store_names <- c("表参道","銀座","池袋","新宿","目黒","駒沢","二子玉川","みなとみらい","中野","上大岡","横浜","吉祥寺")
```
...
receipt %>% 
  ...
  facet_wrap(~store_id_name, scales="free_y") +
